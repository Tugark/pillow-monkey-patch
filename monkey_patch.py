"""
This monkey patch adapts the changes in https://github.com/python-pillow/Pillow/pull/4862 which were only added in
Pillow 8.0.0; so they can be used in Pillow 7.2.0.

Note that this does *NOT* guarantee that everything works; it has just been proven to work with updating GPS exif data.
More functionality might fail as this monkeypatch is (almost) only a copy/past of the patch diff of this commit.
"""
...
from PIL import Image, ImageFile, ImagePalette, TiffTags
from PIL.TiffTags import TYPES
from PIL._binary import o8, i8
